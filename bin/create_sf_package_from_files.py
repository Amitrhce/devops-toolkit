...
def main():
   ...
   for line in sys.stdin:
      print CURRENT_WORKING_PATH + "/" + line.strip()
      if os.path.isfile(CURRENT_WORKING_PATH + "/" + line.strip()):
         added_or_modified.append('"' + line.strip() + '"')

   print "Adding to the package:"
   print added_or_modified
